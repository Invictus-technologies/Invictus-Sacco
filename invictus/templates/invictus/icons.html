...
<html lang="en">
<head>
<title>E-Banking a Banking Category Bootstrap Bootstrap Responsive website Template | Icons :: w3layouts</title>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li><a href="icons.html" class="active" data-toggle="dropdown">Short Codes<span class="caret"></span></a>
			...
			<div class="grid_3 grid_4 w3_agileits_icons_page">
				<div class="icons">   
					<div class="w3ls-title">
						<h2 class="h3-w3l">Font Awesome Icons</h2> 
					</div> 
					<section id="new">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<img src="images/ebank.png" alt="logo"/>
